...
import com.wutong.backmanage.common.constant.dictmap.states.ManagerStatus;
import com.wutong.backmanage.common.scope.DataScope;
...
import com.wutong.backmanage.core.factory.UserFactory;
...
import com.wutong.backmanage.core.tips.Tip;
...
import com.wutong.core.wrapper.UserWarpper;
...
//        DataScope dataScope = new DataScope(ShiroKit.getDeptDataScope());
        List<Map<String, Object>> users = userMapper.selectUsers(name, beginTime, endTime, deptid);
    ...
    public String upload(@RequestPart("file") MultipartFile picture) {
        ...
        try {
            String fileSavePath = wutongBackmanageProperties.getFileUploadPath();
