 ...
 */
(function() {
    var PageTable = function(pageTableId, url, columns) {
        this.ptInstance = null;   //jQuery 与 bootstrapTable的绑定对象
        this.pageTableId = pageTableId;
        this.url = Feng.ctxPath + url;
        this.method = "POST";
        this.paginationType = "server"; //默认使用服务端分页
        this.toolbarId = pageTableId + "Toolbar"
    ...
    PageTable.prototype = {
        //初始化
        init: function() {
            var tableId = this.pageTableId;
            this.ptInstance = $(tableId).bootstrapTable({
        ...
        refresh: function (parms) {
            if (typeof parms != "undefined") {
                this.ptInstance.bootstrapTable('refresh', parms);
            } else {
                this.ptInstance.bootstrapTable('refresh');
            }
        }
    };
