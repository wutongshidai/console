package com.wutong.backmanage.core.template.config;
...
public class ServiceConfig {
    ...
    public void init() {
        ...
        imports.add("com.wutong.backmanage." + contextConfig.getModuleName() + ".service.I" + contextConfig.getBizEnBigName() + "Service");
        this.serviceImplImports = imports;
        this.servicePathTemplate = "\\src\\main\\java\\com\\wutong\\backmanage\\modular\\" + contextConfig.getModuleName() + "\\service\\I{}Service.java";
        this.serviceImplPathTemplate = "\\src\\main\\java\\com\\wutong\\backmanage\\modular\\" + contextConfig.getModuleName() + "\\service\\impl\\{}ServiceImpl.java";
        this.packageName = "com.wutong.backmanage." + contextConfig.getModuleName() + ".service";
    }
